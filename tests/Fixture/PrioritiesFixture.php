...
class PrioritiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'color' => ['type' => 'string', 'length' => 15, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'color' => 'Lorem ipsum d',
            'published' => 1,
            'created' => '2017-04-29 20:08:59',
            'modified' => '2017-04-29 20:08:59',
            'user_created' => 1,
            'user_modified' => 1
        ],
    ];
