...
class CitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'code' => ['type' => 'string', 'length' => 15, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'code' => 'Lorem ipsum d',
            'published' => 1,
            'created' => '2017-04-29 20:06:18',
            'modified' => '2017-04-29 20:06:18',
            'user_created' => 1,
            'user_modified' => 1,
            'country_id' => 1
        ],
